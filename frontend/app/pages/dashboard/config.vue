	...
	<div class="p-6 space-y-8 max-w-3xl mx-auto">
		...
		<div class="flex flex-col md:flex-row items-center justify-between">
			<div>
				...
				<p class="text-sm text-muted mt-1">Ajustes generales del panel</p>
			</div>
		...
		<UPageCard title="Fuente de estadísticas"
			...
			<template #description>
				<div class="space-y-4 mt-4">
					...
					<UFormField label="Fuente">
						<USelectMenu v-model="form.stats.source"
							:options="[
					...
					<UAlert v-if="form.stats.source === 'host'"
						color="primary"
						variant="soft"
					...
					<UAlert v-if="form.stats.source === 'container'"
						color="warning"
						variant="soft"
					...
					<UFormField label="Intervalo de actualización (ms)">
						<UInput v-model.number="form.stats.interval"
							type="number"
							:min="500"
							:max="30000"
							:step="500"
			...
			<template #description>
				<div class="space-y-4 mt-4">
					...
					<UFormField label="Idioma">
						<USelectMenu v-model="form.ui.language"
							:options="[
